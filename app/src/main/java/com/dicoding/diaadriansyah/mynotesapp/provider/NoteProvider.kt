package com.dicoding.diaadriansyah.mynotesapp.provider
...
import com.dicoding.diaadriansyah.mynotesapp.db.DatabaseContract.AUTHORITY
...
import com.dicoding.diaadriansyah.mynotesapp.provider.NoteProvider.Companion.NOTE
...
class NoteProvider : ContentProvider() {
    companion object {
        ...
        misal
        uri com.dicoding.diaadriansyah.mynotesapp dicocokan dengan integer 1
        uricom.dicoding.diaadriansyah.mynotesapp/# dicocokan dengan integer 2
         */
        init {
            // content://com.dicoding.diaadriansyah.mynotesapp/note
            sUriMatcher.addURI(AUTHORITY, TABLE_NAME, NOTE)

            // content://com.dicoding.diaadriansyah.mynotesapp/note/id
    ...
    /*
        ...
        Return cursor
    */
    override fun query(uri: Uri, string : Array<String>?, s: String?,
                       string1: Array<String>?, s1: String?): Cursor? {
        val cursor: Cursor?
